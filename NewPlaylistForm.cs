...
namespace LightSequencer
{
	public partial class NewPlaylistForm : Form
	{
		...
		{
            if (index >= lbSequences.Items.Count)
                return;
			...
			switch(lbs.Sequence.Version)
			{
				case 1:
                    ...
                    //this._player.Start();
                    //this._player.Start(this.ParentForm.ParentForm);
					break;
				case 2:
					this._player = new SequencePlayerV2(lbs.Sequence, this.ParentForm);
					this._player.SequenceStopped += new EventHandler(_sp_SequenceStopped);
                    //this._player.Start();
                    //this._player.Start(this.ParentForm);
					break;
			}
		}
