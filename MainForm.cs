...
namespace LightSequencer
{
	public partial class MainForm : Form
	{
		...
		private void CreateSequence()
		{
			...
			switch(_sequence.Version)
			{
				case 1:
					...
					break;
				case 2:
					_sequencePlayer = new SequencePlayerV2(_sequence, this);
					break;
				default:
        ...
        public void moveGridView(int colIndex)
        {
            if(colIndex < dgvMain.ColumnCount)
                dgvMain.FirstDisplayedScrollingColumnIndex = colIndex;
        }
